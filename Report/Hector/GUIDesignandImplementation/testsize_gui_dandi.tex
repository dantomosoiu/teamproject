...
\caption{First attempt at wireframing GUI}
\end{figure}
...
The initial GUI implementation (\ref{initialGUI}) was a quick and crude attempt towards the initial
...
\begin{figure}
\centering
\label{secondRefinementGUI}
\includegraphics[width=10cm]{../images/GUIv2}
\caption{Second refinement to GUI}
\end{figure}
...
\begin{figure}
\centering
\label{thirdRefinementGUI}
\includegraphics[width=10cm]{../images/GUIv2WF}
\caption{Third refinement to GUI}
\end{figure}
